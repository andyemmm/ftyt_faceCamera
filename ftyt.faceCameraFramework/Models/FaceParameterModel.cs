...
namespace ftyt.faceCameraFramework.Models
{
    public class FaceParameterModel
    {
        ...
        public struct FACE_QUALITY_LEVEL
        {
            ...
            public Int32 nGape; // 张嘴程度(0-100)
            public Int32 nLeftEyeStatus, nRightEyeStatus; // 睁眼程度(0-100)
        ...
        {
            public int FaceQuantity { get; set; }
            public bool FaceQuality { get; set; }
            public List<DisplayFaceQualityLevelItem> DisplayFaceQualityList { get; set; }
            public string Message { get; set; } = "";
            public BitmapSource FaceImage { get; set; }
            public bool IsLiveFace { get; set; }
            public int LiveFaceScore { get; set; }
            public bool FaceResult { get; set; } = false;
        }
    }
}
